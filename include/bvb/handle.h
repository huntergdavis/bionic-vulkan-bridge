...
enum bvb_object_type {
    ...
    BVB_OBJECT_DESCRIPTOR_SET_LAYOUT = 20,
    BVB_OBJECT_DESCRIPTOR_POOL = 21,
    BVB_OBJECT_DESCRIPTOR_SET = 22,
    BVB_OBJECT_SAMPLER = 23,
    BVB_OBJECT_DESCRIPTOR_UPDATE_TEMPLATE = 24,
    BVB_OBJECT_QUERY_POOL = 25,
};
