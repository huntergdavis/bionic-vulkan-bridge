...
enum {
    ...
    BVB_OPCODE_VULKAN_BUFFER_REQUIREMENTS_2 = 78,
    BVB_OPCODE_VULKAN_BUFFER_DEVICE_ADDRESS = 79,
    ...
    BVB_OPCODE_VULKAN_DESCRIPTOR_UPDATE_TEMPLATE_CREATE = 110,
    BVB_OPCODE_VULKAN_BUILTIN_GRAPHICS_PIPELINE_CREATE = 111,
    ...
    BVB_OPCODE_VULKAN_DESCRIPTOR_TRANSACTION_ALLOCATE = 123,
    BVB_OPCODE_VULKAN_DESCRIPTOR_TRANSACTION_RING_SETUP = 124,
    BVB_OPCODE_VULKAN_MEMORY_DIRECT_MAP_SETUP = 125,
    BVB_OPCODE_LAST = BVB_OPCODE_VULKAN_MEMORY_DIRECT_MAP_SETUP,
    ...
    BVB_VULKAN_BUFFER_REQUIREMENTS_2_REQUEST_SIZE = 16,
    BVB_VULKAN_BUFFER_REQUIREMENTS_2_RESPONSE_SIZE = 32,
    BVB_VULKAN_BUFFER_DEVICE_ADDRESS_REQUEST_SIZE = 8,
    BVB_VULKAN_BUFFER_DEVICE_ADDRESS_RESPONSE_SIZE = 8,
    ...
    BVB_VULKAN_INIT_IMAGE_MAX_BARRIERS = 4,
    BVB_VULKAN_COMMAND_BUFFER_IMAGE_BARRIER_REQUEST_SIZE = 48,
    BVB_VULKAN_COMMAND_BUFFER_CLEAR_COLOR_IMAGE_REQUEST_SIZE = 16,
...
enum bvb_vulkan_buffer_requirements_2_pnext_bits {
    BVB_VULKAN_BUFFER_REQUIREMENTS_2_PNEXT_DEDICATED = 1U << 0,
    BVB_VULKAN_BUFFER_REQUIREMENTS_2_PNEXT_MASK =
...
enum bvb_vulkan_buffer_create_internal_bits {
...
struct bvb_vulkan_buffer_device_address_request {
    uint64_t buffer_id;
};

struct bvb_vulkan_buffer_device_address_response {
...
struct bvb_vulkan_command_buffer_image_barrier_request {
    uint64_t command_buffer_id;
    uint32_t image_count;
    uint64_t image_ids[BVB_VULKAN_INIT_IMAGE_MAX_BARRIERS];
};
