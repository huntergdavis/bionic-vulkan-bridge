...
def main() -> int:
    ...
    require(header, "BVB_COMMAND_VULKAN_MAX_MEMORY_BARRIERS", "memory bound")
    require(header, "BVB_COMMAND_VULKAN_MAX_BUFFER_BARRIERS", "buffer bound")
    require(header, "BVB_COMMAND_VULKAN_MAX_IMAGE_BARRIERS", "image bound")
