...
def main() -> int:
    ...
    assert "BVB_SOURCE_COMMIT" in termux_gate
    assert 'source_commit_provenance=environment_override' in termux_gate
    assert 'source_commit_provenance=clean_git_head' in termux_gate
