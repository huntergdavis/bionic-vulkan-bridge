...
def main() -> int:
    ...
    require(global_test, "lease_hits_after_live_batch + 14U", "adaptive local hits")
    require(global_test, "ring_calls_before_second_signature + 3U", "second signature proof")
    require(global_test, "lease_hits_after_live_batch + 15U", "coexisting signature hit")
